...
var send = function (settings, store, api) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
    ...
    return tslib_1.__generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                ...
                _b = (0, helpers_1.isFormHasErrors)(settings, store, false), isFormInvalid = _b[0], formErrors = _b[1];
                if (debug)
            ...
            case 3:
                ...
                throw new errors_1.FormSendError("Request has failed", error_1, _errors_1);
...
var createSend = function (settings) {
    return function (store) {
        return function (next) {
            return function (action) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
